...
<div class="form">
	<form name="frmRegister" onsubmit="return Warning_reg()" action="<?php echo $_SERVER['PHP_SELF'] ?>?controller=master&action=research&function=wr_confirm" method="post" >
    	<table cellspacing="7px" >
            ...
            <tr>
                ...
                <td><input type="text" class="input_text" id="txt_name" name="txt_quest" /></td>
            ...
            <tr>
                ...
                <td><input type="text" class="input_text" id="txt_name" name="txt_idea1" /></td>
                <td>Vd: Tốt</td>
            </tr>
            
            <tr>
            	<td><label>Ý kiến 2:</label></td>
                <td><input type="text" class="input_text" id="txt_name" name="txt_idea2" /></td>
                <td>Vd: Khá</td>
            </tr>
            
            <tr>
            	<td><label>Ý kiến 3:</label></td>
                <td><input type="text" class="input_text" id="txt_name" name="txt_idea3" /></td>
                <td>Vd: Trung bình</td>
            </tr>
            ...
            <tr>
                ...
                <td><p>
                  <label>
                    <input name="rdo_status" type="radio" id="rdo_status_0" value="1" checked="checked" />
                    Tiến hành</label>&nbsp;&nbsp;
                  <label>
                    <input type="radio" name="rdo_status" value="0" id="rdo_status_1" />
                    Dự thảo</label>
                  <br />
                </p></td>
            </tr>
