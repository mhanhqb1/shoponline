		...
		<div id='show_cart'>
			<table>
				<tr id='head_showcart'>
					...
					<td style='width: 350px;'>Khách hàng</td>
					<td style='width: 120px;'>Sản phẩm</td>
                ...
                ?>        
                        ...
                        <td>
                        	<form name="frmDate" action="<?php echo $_SERVER['PHP_SELF'] ?>?controller=master&action=order&function=setShipping" method="post" >                            
                                <input class="input_text" type="text" name="input_text_mhd" style="display: none;" value="<?php echo $item['mahoadon'];?>" />
                                <div class='btn_luu'><input style="height: 22px; line-height: 12px;" type='submit' title='Giao sản phẩm' class='btn_shipping'  value='' /></div>
                            </form>
