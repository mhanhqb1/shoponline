...
<div id="center_bar">
    ...
    <a href="<?php echo $_SERVER['PHP_SELF'] ?>?controller=master&action=warehouse&function=list">Tìm kiếm, điều chỉnh thông tin</a> 
    > Tìm kiếm sản phẩm
</div>
			...
			<table>
                ...
                ?>        
                					<form name="frmEdit" action="<?php echo $_SERVER['PHP_SELF'] ?>?controller=master&action=warehouse&function=edit" method="post"  >                            	
                                        ...
                                        <input style="text-align:center; width: 50px; height: 22px; line-height: 12px;" class="input_text" type="text" name="txt_qt" value="<?php echo $item['soluongcon'];?>" />
