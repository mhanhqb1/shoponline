...
<div class="label_content">
	...
	<form name="frmWrite" onsubmit="return Warning()" action="<?php echo $_SERVER['PHP_SELF'] ?>?controller=master&action=news&function=send_wr_edit_sale&id=<?php echo $id;?>" method="post">
