<script type="text/javascript">
	...
	//return true;  
		...
		if(x.txt_title.value.length < 1) {
			alert("Vui lòng nhập tựa để bài viết!"); x.txt_title.focus(); return false; 
		}
	}
</script>
<div id="center_bar">
...
<div class="label_content">
    ...
    <div style="width: 100%;">
    	Tựa đề bài viết: <input type="text" name="txt_title" id="txt_title" style="height:25px; width: 350px;" value='<?php if(isset($_SESSION['ses_title'])){ echo $_SESSION['ses_title'];}?>' /><br /><br />
