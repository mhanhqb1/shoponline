...
<div id="content_right" style='float: right;'>
        	...
        	<div class="sidebox-body-cnt">  
				<?php
					if(isset($_SESSION['ses_username']) && isset($_SESSION['ses_level'])){
                        ...
                        <div class="user_space"><a href="<?php echo $_SERVER['PHP_SELF'] ?>?controller=user&action=personal"> Thông tin cá nhân </a></div>
                        <div class="user_space"><a href="<?php echo $_SERVER['PHP_SELF'] ?>?controller=user&action=history"> Lịch sử giao dịch </a></div>
                        <div class="user_space"><a href="<?php echo $_SERVER['PHP_SELF'] ?>?controller=user&action=password">Đổi mật khẩu </a></div>
                        
						<form onsubmit="return Warning_log_out()" action="<?php echo $_SERVER['PHP_SELF'] ?>?controller=user&action=log_out" method="post" >                            
					...
					<?php	
                        ...
                        <form name="frm_Login" action="<?php echo $_SERVER['PHP_SELF'] ?>?controller=user&action=check_login" method="post" onsubmit="return Warning_login()">
                            ...
                            <a href="<?php echo $_SERVER['PHP_SELF'] ?>?controller=user&action=forgot_password"> Quên mật khẩu? </a>
    ...
    <?php
     ...
     <div class="sidebox" > 
        ...
        <div class="sidebox-body-r"><div class="sidebox-body-l"><div class="sidebox-body-c"> 
        	<div class="sidebox-body-cnt">
            <form <?php if(!isset($_SESSION['ses_research'])){ ?>onsubmit="return Warning_research()"<?php }?> name="frmResearch" action="<?php echo $_SERVER['PHP_SELF'] ?>?controller=research&action=send" method="post">
