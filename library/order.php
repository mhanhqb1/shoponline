		...
		if(
			...
			isset($_POST['input_text_phonenumber'])
				...
				if($_SESSION['ses_ch_pttt'] == 'card'){
					...
					$_SESSION['ses_mhd_nganluong'] = $mahoadon;
					$_SESSION['ses_nganluong'] = $mahoadon."gradeus"."@&@%";
					echo $_SESSION['ses_nganluong'];
					echo 
						"
						<script type='text/javascript'>window.location='https://www.nganluong.vn/button_payment.php?receiver=gds.gradeus@gmail.com&product_name=$mahoadon&price=2000&return_url=http://gradeus.comyr.com';
						</script>";	
				}else{
					if(isset($_SESSION['ses_id'])){
						$gv_class_cart->Order_for_user(
